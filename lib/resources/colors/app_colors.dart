...
//Custom Color
  ...
  @override
  Color get primaryColor => const Color(0xff0095DA);

  @override
  Color get secondaryColor => const Color(0xFF0A0B1C);

  @override
  Color get primaryColorBackground => const Color(0xFFF7F7F7);

  @override
  Color get primaryColorBorder => const Color(0xFFE0E0E0);
  @override
  Color get secondaryColorBorder => const Color(0xffE8E9E9);

  @override
  Color get primaryTextColor => const Color(0xFF2F3C4F);
  @override
  Color get secondaryTextColor => const Color(0xFF8F97A2);
  @override
  Color get tertiaryTextColor => const Color(0xFF616C7B);
  @override
  Color get bottomBorderColor => const Color(0xffE8E9E9);
  @override
  Color get iconColor => const Color(0xff9C9C9C);
  @override
  Color get withdrawColor => const Color(0xffFF4AF8);
  @override
  Color get depositColor => const Color(0xffDD9F00);
  @override
  Color get transferColor => const Color(0xff00DAF8);
  @override
  Color get cashoutColor => const Color(0xffAD5CA4);
  @override
  Color get incomeColor => const Color(0xff4ABE9C);
  @override
  Color get expenseColor => const Color(0xffF2705A);
  @override
  Color get infoColor => const Color(0xffF58E07);
  @override
  Color get basicPackageColor => const Color(0xff31AEE8);
  @override
  Color get standardPackageColor => const Color(0xff2370CC);
  @override
  Color get enterprisePackageColor => const Color(0xff127793);

  @override
  Color get disabledColor => const Color(0xffE5E5E5);
  ...
  //blue
  @override
  Color get blue => const Color(0xff0082C6);
  @override
  ...
  @override
  Color get red => const Color(0xffDE4822);
  @override
  ...
  @override
  Color get appBlue => const Color(0xFF1178AF);

  @override
  Color get appGreen => const Color(0xFF3F9A7F);

  @override
  Color get appRed => const Color(0xFFC55A49);

  @override
  Color get appViolate => const Color(0xFF7C2977);
}
